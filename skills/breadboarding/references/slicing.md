...
Slicing takes a breadboard and groups its affordances into **vertical implementation slices**. See [examples.md](./examples.md) Example B for a complete slicing example.
