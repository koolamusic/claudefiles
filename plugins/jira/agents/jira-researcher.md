...
- Check `.claude/skills/` and `~/.claude/skills/` — list subdirectories, read each `SKILL.md`. Skills may dictate what counts as "this repo's pattern" (e.g. a `react-best-practices` skill informs the `patterns` focus).
